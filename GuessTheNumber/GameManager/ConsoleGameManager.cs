using GuessTheNumber.GameSound.ConsoleSound;

namespace GuessTheNumber.GameManager
{
    class ConsoleGameManager : IGameManager
    {
        ...
        public void PlaySoundTrack()
        {
            ...
            Task.Factory.StartNew(() => PlaySoundTrack(ConsoleSoundTracks.MissionImpossible, _cancelTokenSource.Token), _cancelTokenSource.Token);
        }
